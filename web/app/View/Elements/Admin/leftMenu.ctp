...
?><div class="col-md-3">
	...
	<div class="side-bar-wrapper collapse navbar-collapse navbar-ex1-collapse">
		...
		<ul class="side-menu">
			<li> <a href="<?php echo $this->Html->url('/notifications', true); ?>"> <span class="badge badge-notifications pull-right alert-animated">5</span> <i class="icon-flag"></i> Notifications </a> </li>
		</ul>
		<div class="relative-w">
			<ul class="side-menu">
				<li class='current'> <a class='current' href="<?php echo $this->Html->url('/', true); ?>"> <span class="badge pull-right">17</span> <i class="icon-dashboard"></i> Dashboard </a> </li>
				<li> <a href="<?php echo $this->Html->url('/applications', true); ?>"> <span class="badge pull-right">12</span> <i class="icon-briefcase"></i> Applications </a> </li>
				<li> <a href="<?php echo $this->Html->url('/users', true); ?>"> <span class="badge pull-right">12</span> <i class="icon-user"></i> Users </a> </li>
				<li> <a href="<?php echo $this->Html->url('/groups', true); ?>"> <span class="badge pull-right">12</span> <i class="icon-group"></i> Groups </a> </li>
				<li> <a href="<?php echo $this->Html->url('/categories', true); ?>"> <span class="badge pull-right">12</span> <i class="icon-list-ul"></i> Categories </a> </li>
				<li> <a href="<?php echo $this->Html->url('/policies', true); ?>" class="is-dropdown-menu"> <span class="badge pull-right"></span> <i class="icon-shield"></i> Policies </a>
					<ul>
				...
				<li> <a href="<?php echo $this->Html->url('/analytics', true); ?>" class="is-dropdown-menu"> <span class="badge pull-right"></span> <i class="icon-bar-chart"></i> Analytics </a>
					<ul>

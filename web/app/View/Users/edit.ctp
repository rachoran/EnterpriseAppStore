...
?><div class="widget">
	<div class="widget-content-white glossed">
		<div class="padded">
			...
			?>
			<h3 class="form-title form-title-first"><i class="icon-user"></i> <?= ((bool)$id) ? 'Edit user "'.$user['firstname'].' '.$user['lastname'].'"' : 'Create user'; ?></h3>
			...
			<div class="form-group">
				<label class="col-md-4 control-label"><?= $changePassword; ?>Password</label>
				<div class="col-md-8">
					<?php
			...
			<div class="form-group">
				<div class="col-md-offset-4 col-md-8">
					<a href="<?= $this->Html->url('/users', true); ?>" class="btn btn-default">Cancel</a>
